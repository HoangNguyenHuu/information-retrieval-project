...
public class TestPerformance {
    public static void main(String[] args) throws ParseException, InvalidTokenOffsetsException, IOException {
        ...
        for (int i = 0; i < queries.size(); i++) {
            ...
            int total_system_true = get_number_result_true_system(relevance_this_query, docs, query_id);
    ...
    public static int get_number_result_true_system(JsonArray relevances, JsonArray docs, int query_id) throws FileNotFoundException {
